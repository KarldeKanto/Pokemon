    ...
    */
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			button.textContent = "Añadir Pokemon";
    			br8 = element("br");
    			t12 = space();
    			form1 = element("form");
    			input8 = element("input");
    			attr_dev(h1, "class", "svelte-1tky8bj");
    			add_location(h1, file, 55, 1, 825);
    			attr_dev(input0, "type", "text");
    			attr_dev(input0, "id", "numeropokedex");
    			attr_dev(input0, "placeholder", "Numero de la Pokedex");
    			input0.required = true;
    			add_location(input0, file, 58, 2, 853);
    			add_location(br0, file, 58, 123, 974);
    			attr_dev(input1, "type", "text");
    			attr_dev(input1, "id", "pokemon");
    			attr_dev(input1, "placeholder", "pokemon");
    			input1.required = true;
    			add_location(input1, file, 59, 2, 981);
    			add_location(br1, file, 59, 98, 1077);
    			attr_dev(input2, "type", "text");
    			attr_dev(input2, "id", "categoria");
    			attr_dev(input2, "placeholder", "Categoria");
    			input2.required = true;
    			add_location(input2, file, 60, 2, 1084);
    			add_location(br2, file, 60, 104, 1186);
    			attr_dev(input3, "type", "text");
    			attr_dev(input3, "id", "habilidad");
    			attr_dev(input3, "placeholder", "Habilidad/es");
    			input3.required = true;
    			add_location(input3, file, 61, 2, 1193);
    			add_location(br3, file, 61, 107, 1298);
    			attr_dev(input4, "type", "text");
    			attr_dev(input4, "id", "peso");
    			attr_dev(input4, "placeholder", "Peso");
    			input4.required = true;
    			add_location(input4, file, 62, 2, 1305);
    			add_location(br4, file, 62, 89, 1392);
    			attr_dev(input5, "type", "text");
    			attr_dev(input5, "id", "altura");
    			attr_dev(input5, "placeholder", "Altura");
    			input5.required = true;
    			add_location(input5, file, 63, 2, 1399);
    			add_location(br5, file, 63, 95, 1492);
    			attr_dev(input6, "type", "text");
    			attr_dev(input6, "id", "habitat");
    			attr_dev(input6, "placeholder", "Habitat");
    			input6.required = true;
    			add_location(input6, file, 64, 2, 1499);
    			add_location(br6, file, 64, 98, 1595);
    			attr_dev(input7, "type", "text");
    			attr_dev(input7, "id", "generacion");
    			attr_dev(input7, "placeholder", "Generacion");
    			input7.required = true;
    			add_location(input7, file, 65, 2, 1602);
    			add_location(br7, file, 65, 107, 1707);
    			option.__value = "elegir";
    			option.value = option.__value;
    			add_location(option, file, 67, 3, 1732);
    			add_location(select, file, 66, 8, 1720);
    			add_location(form0, file, 57, 1, 844);
    			add_location(button, file, 70, 1, 1787);
    			add_location(br8, file, 70, 53, 1839);
    			attr_dev(input8, "type", "text");
    			attr_dev(input8, "placeholder", "Añadir tipo");
    			add_location(input8, file, 72, 2, 1867);
    			attr_dev(form1, "class", "tipo");
    			add_location(form1, file, 71, 1, 1845);
    			attr_dev(main, "class", "svelte-1tky8bj");
    			add_location(main, file, 53, 0, 816);
    		},
    		...
    		m: function mount(target, anchor) {
    			...
    			set_input_value(input0, /*pokemonster*/ ctx[0].numeropokedex);
    			append_dev(form0, br0);
    			append_dev(form0, t2);
    			append_dev(form0, input1);
    			set_input_value(input1, /*pokemonster*/ ctx[0].pokemon);
    			append_dev(form0, br1);
    			append_dev(form0, t3);
    			append_dev(form0, input2);
    			set_input_value(input2, /*pokemonster*/ ctx[0].categoria);
    			append_dev(form0, br2);
    			append_dev(form0, t4);
    			append_dev(form0, input3);
    			set_input_value(input3, /*pokemonster*/ ctx[0].habilidad);
    			append_dev(form0, br3);
    			append_dev(form0, t5);
    			append_dev(form0, input4);
    			set_input_value(input4, /*pokemonster*/ ctx[0].peso);
    			append_dev(form0, br4);
    			append_dev(form0, t6);
    			append_dev(form0, input5);
    			set_input_value(input5, /*pokemonster*/ ctx[0].altura);
    			append_dev(form0, br5);
    			append_dev(form0, t7);
    			append_dev(form0, input6);
    			set_input_value(input6, /*pokemonster*/ ctx[0].habitat);
    			append_dev(form0, br6);
    			append_dev(form0, t8);
    			append_dev(form0, input7);
    			set_input_value(input7, /*pokemonster*/ ctx[0].generacion);
    			...
    			if (!mounted) {
    				dispose = [
    					...
    					listen_dev(button, "click", /*Poke*/ ctx[1], { once: true }, false, false)
    				];
    		...
    		p: function update(ctx, [dirty]) {
    			if (dirty & /*pokemonster*/ 1 && input0.value !== /*pokemonster*/ ctx[0].numeropokedex) {
    				set_input_value(input0, /*pokemonster*/ ctx[0].numeropokedex);
    			}

    			if (dirty & /*pokemonster*/ 1 && input1.value !== /*pokemonster*/ ctx[0].pokemon) {
    				set_input_value(input1, /*pokemonster*/ ctx[0].pokemon);
    			}

    			if (dirty & /*pokemonster*/ 1 && input2.value !== /*pokemonster*/ ctx[0].categoria) {
    				set_input_value(input2, /*pokemonster*/ ctx[0].categoria);
    			}

    			if (dirty & /*pokemonster*/ 1 && input3.value !== /*pokemonster*/ ctx[0].habilidad) {
    				set_input_value(input3, /*pokemonster*/ ctx[0].habilidad);
    			}

    			if (dirty & /*pokemonster*/ 1 && input4.value !== /*pokemonster*/ ctx[0].peso) {
    				set_input_value(input4, /*pokemonster*/ ctx[0].peso);
    			}

    			if (dirty & /*pokemonster*/ 1 && input5.value !== /*pokemonster*/ ctx[0].altura) {
    				set_input_value(input5, /*pokemonster*/ ctx[0].altura);
    			}

    			if (dirty & /*pokemonster*/ 1 && input6.value !== /*pokemonster*/ ctx[0].habitat) {
    				set_input_value(input6, /*pokemonster*/ ctx[0].habitat);
    			}

    			if (dirty & /*pokemonster*/ 1 && input7.value !== /*pokemonster*/ ctx[0].generacion) {
    				set_input_value(input7, /*pokemonster*/ ctx[0].generacion);
    			}
    		},
    		i: noop,
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	const loadData = async () => {
    		const querySnapshot = await lh(ba(db, "pokemon"));
    		let docs = [];
    	...
    	const addPokemon = async () => {
    		await gh(ba(db, "pokemon"), pokemonster);
    		await loadData();
    	};
    	...
    	function input0_input_handler() {
    		pokemonster.numeropokedex = this.value;
    		$$invalidate(0, pokemonster);
    	}

    	function input1_input_handler() {
    		pokemonster.pokemon = this.value;
    		$$invalidate(0, pokemonster);
    	}

    	function input2_input_handler() {
    		pokemonster.categoria = this.value;
    		$$invalidate(0, pokemonster);
    	}

    	function input3_input_handler() {
    		pokemonster.habilidad = this.value;
    		$$invalidate(0, pokemonster);
    	}

    	function input4_input_handler() {
    		pokemonster.peso = this.value;
    		$$invalidate(0, pokemonster);
    	}

    	function input5_input_handler() {
    		pokemonster.altura = this.value;
    		$$invalidate(0, pokemonster);
    	}

    	function input6_input_handler() {
    		pokemonster.habitat = this.value;
    		$$invalidate(0, pokemonster);
    	}

    	function input7_input_handler() {
    		pokemonster.generacion = this.value;
    		$$invalidate(0, pokemonster);
    	}
    	...
    	$$self.$inject_state = $$props => {
    		if ('pokemonster' in $$props) $$invalidate(0, pokemonster = $$props.pokemonster);
    		if ('guardarPokemon' in $$props) guardarPokemon = $$props.guardarPokemon;
    	};
